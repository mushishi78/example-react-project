namespace Test {
	Tatt.addTest(tests, "Tetris.View", "renders an empty board", t => {
	...
	Tatt.addTest(tests, "Tetris.View", "renders an single shape", t => {
		const emptyState: Tetris.AppState = {
			lib: {},
			tetris: {
				shapes: [
	...
	Tatt.addTest(tests, "Tetris.View", "renders multiple shapes", t => {
		const emptyState: Tetris.AppState = {
			lib: {},
			tetris: {
				shapes: [
